                    ...
                    if($queryExe){
                        ?>
                            <script>
                                ...
                                window.open("http://localhost/SMS/Faculty/faculty_assignments.php","_self");
                            </script>
                        <?php
                    }else{
                        ?>
                    ...
                    if($queryExe){
                        ?>
                            <script>
                                ...
                                window.open("http://localhost/SMSlty/faculty_assignments.php","_self");
                            </script>
                        <?php
                    }else{
                        ?>
                            <script>
                                alert("Something Went Wrong !");
                                window.open("http://localhost/SMSaculty_assignments.php","_self");
                            </script>
                        <?php
                    }
                }
                    ...
                    if($queryExe){
                        ?>
                            <script>
                                ...
                                window.open("http://localhost/SMSy_assignments.php","_self");
                            </script>
                        <?php
                    }else{
                        ?>
                            <script>
                                alert("Something Went Wrong !");
                                window.open("http://localhost/SMSignments.php","_self");
                            </script>
                        <?php
                    }
                }
                ...
                $C_des = $_POST[$C_DES];
                    ...
                    if($queryExe){
                        ...
                        ?>
                            <script>
                                alert("Something Went Wrong !");
                                window.open("http://localhost/SMSnts.php","_self");
                            </script>
                        <?php
                    }
                }
