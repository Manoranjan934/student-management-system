...
<html lang="en-US" style="text-align: center;">
    ...
    <body>
        ...
        <div class="split left">
            <div class="centered">
                <img src="images_faculty/faculty_login.png" width="400px">
                <h1 style="font-family: Comic Sans MS ; color: white">Welcome Back</h1>
                <p style="font-family: Comic Sans MS ; color: white">To Keep Connected With Us Please Signin With Your Faculty Info.</p>
            </div>
        </div>
    ...
    <?php
        ...
        if(isset($_POST['btnLogin'])){
            ...
            if($data){
                ...
                <script type="text/javascript">
                    ...
                    window.open("http://localhost/SMS/Faculty/Faculty_panel.php","_self")
                </script>
            <?php
            }else{
                ?>
        ...
        if(isset($_POST['go_to_home'])){
            ?>
                <script type="text/javascript">
                    window.open("http://localhost/SMS/main.php","_self")
                </script>
            <?php
        }
